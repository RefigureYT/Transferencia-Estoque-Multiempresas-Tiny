            ...
            if (fs.lstatSync(filePath).isFile()) {
                ...
                if (spreadsheetExtensions.includes(ext)) {
                    try {
                        ...
                        console.error(`❌ Erro ao remover arquivo de planilha antigo ${file}:`, e.message);
                    }
                }
            }
        }
    ...
    try {
        ...
        browser = await puppeteer.launch({
            ...
            args: [
                ...
                '--disable-dev-shm-usage', // evita problemas de memória em /dev/shm
                '--disable-gpu',           // sem GPU no servidor, evita erros
                '--single-process',        // opcional em ambientes restritos
                '--no-zygote'
        ...
        await new Promise((resolve, reject) => {
            const options = {
                ...
                timeout: 150000 // Aumentado para 2.5 minutos (150 segundos) para o download
            };
        ...
        throw err; // Re-lança o erro para ser tratado por quem chamou a função
    } finally {
